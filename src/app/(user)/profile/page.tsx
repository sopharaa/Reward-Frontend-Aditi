...
export default function Profile() {
    ...
    const inputClass = "block w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 sm:text-sm";
            ...
            <div className="w-[85%] mx-auto py-8">
                ...
                <div className="bg-gradient-to-r from-purple-600 to-indigo-700 text-white p-6 rounded-lg shadow-md mb-8 flex flex-col md:flex-row items-center justify-between">
                    <div className="flex items-center mb-4 md:mb-0">
                        {isLoading ? (
                            <div className="w-20 h-20 rounded-full border-2 border-white mr-4 bg-purple-400 animate-pulse" />
                        ) : user?.profileImage ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="flex justify-end pt-2">
                            <button
                                ...
                                className="bg-purple-600 hover:bg-purple-700 text-white font-semibold px-8 py-3 rounded-md shadow-md transition disabled:opacity-50 disabled:cursor-not-allowed"
                            >
