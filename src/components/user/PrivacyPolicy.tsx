            ...
            <div className="container mx-auto p-6 bg-white rounded-xl shadow-lg max-w-4xl w-full">
                ...
                <nav className="flex justify-between items-center mb-10 pb-4 border-b border-gray-200">
                    ...
                    <ul className="flex space-x-6">
                        ...
                        <li><Link href="/terms" className="text-gray-700 hover:text-green-600 font-medium transition duration-300">Terms</Link></li>
                        <li><Link href="/privacy-policy" className="text-green-600 font-medium transition duration-300">Privacy</Link></li>
                    </ul>
                </nav>
